...
```{r}
#| echo: false
german_speakers_numeric <- read_excel(
...
#| echo: true
labs(
  title = "<b style='color: orange;'>Penguins on Biscoe island</b> 
...
1. Use color strategically in my title using the `
ggtext
` package
...
1. Use color strategically in your title using the `
ggtext
` package
...
penguins_bar_chart <-
  penguins_bar_chart +
  labs(
    title = "In 2007, <b style='color: orange;'>Dream island</b> had the most penguins of any island"
  )
```
